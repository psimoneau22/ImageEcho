var tradeSumoUtils = (function () {
    ...
    function resizeImage(imageFile, settings, callback, thisContext) {
        ...
        imageObj.onload = function (tt) {
            ...
            var fileName = (imageFile.name.substr(0, imageFile.name.lastIndexOf('.')) || imageFile.name) + ".jpg";
            callback.call(thisContext, dataURLToFile(canvas.toDataURL("image/jpeg", options.qualityFactor), fileName));
